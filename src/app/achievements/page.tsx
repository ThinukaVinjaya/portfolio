...
export default function AchievementsPage() {
  ...
  return (
    <main className="w-full bg-[#0a0a0a] min-h-screen relative py-20 overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-6 lg:px-8 pt-12 md:pt-24">
        {/* Navigation */}
        <Link href="/" className="inline-flex items-center text-neutral-400 hover:text-white transition-all mb-16 group bg-white/5 px-4 py-2 rounded-full border border-white/10 hover:bg-white/10 backdrop-blur-md">
        ...
        >
          <div className="max-w-2xl">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-neutral-200 to-neutral-500 mb-6 drop-shadow-xl">
              The Journey
            </h1>
            <p className="text-neutral-400 text-lg md:text-xl font-light leading-relaxed">
              A timeline mapping my growth through four years of deep diving into technology. From hackathons to open source, these milestones shaped my engineering mindset.
            </p>
          </div>
            ...
            return (
              <div key={item.id} className="relative mb-24 md:mb-40 last:mb-0 group">
                ...
                <div className="absolute left-6 md:left-1/2 top-12 -translate-x-1/2 md:-translate-x-1/2 z-20 flex items-center justify-center">
                  <div className="absolute w-12 h-12 bg-white/10 rounded-full animate-ping opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                `}>
                  ...
                  >
                    ...
                    <div className={`relative p-1 rounded-[2rem] bg-gradient-to-br ${item.color} overflow-hidden group-hover:-translate-y-2 transition-transform duration-500`}>
                      ...
                      <div className="relative z-10 bg-white/[0.02] backdrop-blur-xl p-6 md:p-8 rounded-[calc(2rem-1px)] h-full w-full border border-white/5 shadow-2xl">
                        ...
                        <div className="flex items-center justify-between mb-6">
                          ...
                          <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:rotate-12 transition-transform">
                            <Icon className="w-5 h-5 text-neutral-300 group-hover:text-white transition-colors" />
                          </div>
                        </div>
                        
                        <div className="relative w-full h-56 rounded-2xl overflow-hidden mb-6 border border-white/5 ring-1 ring-black/50 shadow-2xl">
                        ...
                        <div className="flex flex-wrap gap-2 mt-auto">
                          {item.tags.map(tag => (
                            <span key={tag} className="px-3 py-1 text-xs text-neutral-400 bg-black/40 rounded-md border border-white/5 group-hover:border-white/20 transition-colors">
                              {tag}
                            </span>
                          ))}
                        </div>
