...
export default function Home() {
  return (
    <main className="w-full bg-[#121212] min-h-screen relative">
      ...
      <section className="w-full pt-16 pb-32 px-6 lg:px-8 flex flex-col justify-center items-center relative overflow-hidden bg-gradient-to-b from-[#121212] to-[#0a0a0a]">
        ...
        <div className="max-w-6xl w-full flex justify-center relative z-10 mb-32">
          <ActionButtons />
        </div>
